import{_ as l,c as n,o as s,A as e}from"./app.88061379.js";const A=JSON.parse('{"title":"Web构建优化","description":"","frontmatter":{"title":"Web构建优化","author":"Potter","date":"2022-05-12 18:48","tags":["DllPlugin","DllReferencePlugin","打包优化"],"categories":["webpack"]},"headers":[{"level":3,"title":"概要内容","slug":"概要内容","link":"#概要内容","children":[]},{"level":3,"title":"DllPlugin 和 DllReferencePlugin 简介","slug":"dllplugin-和-dllreferenceplugin-简介","link":"#dllplugin-和-dllreferenceplugin-简介","children":[]},{"level":3,"title":"如何使用DllPlugin打包，及DllReferencePlugin如何引用dll","slug":"如何使用dllplugin打包-及dllreferenceplugin如何引用dll","link":"#如何使用dllplugin打包-及dllreferenceplugin如何引用dll","children":[]},{"level":3,"title":"构建优化效果","slug":"构建优化效果","link":"#构建优化效果","children":[]},{"level":3,"title":"SplitChunks","slug":"splitchunks","link":"#splitchunks","children":[]},{"level":3,"title":"Demo源码工程","slug":"demo源码工程","link":"#demo源码工程","children":[]},{"level":3,"title":"最后：","slug":"最后","link":"#最后","children":[]},{"level":3,"title":"参考文献","slug":"参考文献","link":"#参考文献","children":[]}],"relativePath":"article/05-optimize/Optimization/WebBuild01.md","lastUpdated":1678862935000}'),a={name:"article/05-optimize/Optimization/WebBuild01.md"},p=e(`<h3 id="概要内容" tabindex="-1">概要内容 <a class="header-anchor" href="#概要内容" aria-hidden="true">#</a></h3><ul><li>DllPlugin 和 DllReferencePlugin 简介</li><li>如何使用DllPlugin打包，及DllReferencePlugin如何引用dll</li><li>构建优化效果</li><li>SplitChunks</li><li>Demo源码工程</li></ul><hr><h3 id="dllplugin-和-dllreferenceplugin-简介" tabindex="-1">DllPlugin 和 DllReferencePlugin 简介 <a class="header-anchor" href="#dllplugin-和-dllreferenceplugin-简介" aria-hidden="true">#</a></h3><ul><li>DllPlugin:</li></ul><blockquote><p>这个插件是在一个额外的独立的 webpack 设置中创建一个只有 dll 的 bundle(dll-only-bundle)。 这个插件会生成一个名为 manifest.json 的文件，这个文件是用来让 DLLReferencePlugin 映射到相关的依赖上去的。</p></blockquote><ul><li>DllReferencePlugin:</li></ul><blockquote><p>此插件配置在 webpack 的主配置文件中，此插件会把 dll-only-bundles 引用到需要的预编译的依赖中</p></blockquote><ul><li>通俗点讲：</li></ul><blockquote><p>DllPlugin 插件负责把第三方公共库，打包进一个独立的dll库中。最后项目打包时DllReferencePlugin 通过manifest.json 来引用dll的公共库，避免项目每次构建时都将第三库和业务代码进行重复打包。</p></blockquote><ul><li>优点： <ul><li>提升打包构建速度</li><li>公共js文件配置CDN，避免掉重复下载公共库js文件</li></ul></li></ul><hr><h3 id="如何使用dllplugin打包-及dllreferenceplugin如何引用dll" tabindex="-1">如何使用DllPlugin打包，及DllReferencePlugin如何引用dll <a class="header-anchor" href="#如何使用dllplugin打包-及dllreferenceplugin如何引用dll" aria-hidden="true">#</a></h3><ul><li>DllPlugin 配置需要打包第三方库至dll中</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">//webpack.dll.config.js</span></span>
